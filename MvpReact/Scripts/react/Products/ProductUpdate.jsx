...
export default class ProductUpdate extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <Modal style={{ height: "215px", left: "500px", top: "200px", width: "400px" }}
                    ...
                    <Modal.Content>
                        <Form>
                            <Form.Field>
                                <label>Name</label>
                                <input autofocus="true" type="text" name="ProductName" placeholder='Name' defaultValue={this.props.Name} onChange={this.props.onChange} />
                                <div style={{ color: 'red' }}>
