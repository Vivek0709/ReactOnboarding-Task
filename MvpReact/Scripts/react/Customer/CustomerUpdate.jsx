...
export default class CustomerUpdate extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <Modal style={{ height: "215px", left: "500px", top: "200px", width: "400px" }} open={this.props.showUpdateModel} onClose={this.props.onClose} size='small'>
                    <Modal.Header> Edit Customer </Modal.Header>
                    <Modal.Content>
                        <Form>
                            <Form.Field>
                                <label>Name</label>
                                <input autofocus="true" type="text" name="CustomerName" placeholder='Name' defaultValue={this.props.Name} onChange={this.props.onChange} />
                                <div style={{ color: 'red' }}>
